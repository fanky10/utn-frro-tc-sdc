...
public class Grapher
{
  ...
  public void resetTimer()
  {
    ...
    this.timerCurve = new Timer(20, new ActionListener()
    {
      public void actionPerformed(ActionEvent e) {
        if ((Grapher.this.t <= Grapher.this.curveTime * 7.0D) && (Grapher.this.flag == 0)) {
        ...
        if ((Grapher.this.t < Grapher.this.curveTime * 7.0D) && (Grapher.this.flag == 1)) {
        ...
        if ((Grapher.this.t < Grapher.this.curveTime * 7.0D) && (Grapher.this.flag == 2))
        {
          ...
          int j = (arrayOfValueMarker = Grapher.this.curvaActual.getMarcadoresCurva()).length; for (int i = 0; i < j; i++) { ValueMarker marcador = arrayOfValueMarker[i];
            Grapher.this.diagrama.getXYPlot().addDomainMarker(marcador);
          }
        }
        
        if ((Grapher.this.t < Grapher.this.curvaActual.getRealT()) && (Grapher.this.flag == 3))
        {
        ...
        {
          Grapher.this.globalPanelView.completeTables(Grapher.this.graph, Grapher.this.kPlant, Grapher.this.curveTime);
          ...
          if (Grapher.this.flag == 15) {
            Grapher.this.globalPanelView.completeTableController(Grapher.this.graph, Grapher.this.kPlant, Grapher.this.curveTime);
            Grapher.this.stop();
          }
        }
      }
  ...
  public void start() { this.timerCurve.start(); }
